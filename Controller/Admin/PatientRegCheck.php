<?php
    ...
    $NameErr =$emailErr = $userNameErr = $mobNumErr = $nidNumErr =  $passwordErr = $conPasswordErr = $genderErr =  $dobErr =  "" ;
    ...
    if(isset($_POST["submit"]))
    {
        ...
        if($Name != "" && $email != "" && $userName != "" && $mobNum != "" && $nidNum != "" && $password != "" && $conPassword != "" && $gender != "" && $dob != "" )
        {
          
          $PatientUsers = $Name."|".$email."|".$userName."|".$mobNum."|".$nidNum."|".$password."|".$gender."|".$dob;

          $file1 = fopen("PatientReg.txt", "a");
          fwrite($file1, $PatientUsers);
          fwrite($file1, "\n");
