<?php
    ...
    if(isset($_POST["submit"]))
    {
       ...
       if(empty($_POST['email'])) 
        ...
        if($Name != "" && $email != "" && $userName != "" && $mobNum != "" && $nidNum != "" && $dlicense != "" && $password != "" && $conPassword != "" && $gender != "" && $dob != "" )
        {

          insertDoc($Name, $email, $userName, $mobNum, $nidNum, $dlicense, $password, $conPassword, $gender, $dob);
