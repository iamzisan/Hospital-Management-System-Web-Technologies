<?php
    ...
    if($Name != "" && $email != "" && $userName != "" && $mob != "" && $nidNo != "" && $license != "" && $password != "" 
          && $conPassword != "" && $gender != "" && $dob != "" )
        {
          $type= 'doctor';
          $con = mysqli_connect('localhost', 'root', '','patient');

          $sql = "INSERT INTO 
				doctor_req (name, email, username, mobnum, nidnum, license, password, confirmpassword, gender, dob,type) 
