    ...
    if($Name != "" && $email != "" && $mob != "" && $gender != "" && $add != "" && $userName != "" && $password != "" && 
        $conPassword != "" && $dob != "" &&  $license != "" && $nidNo != "" && $pharmacyNo != "")
        {
         ...
         $type = "pharmacy"; 
          ...
          $sql = "INSERT INTO pharmacy_registration (name, email, phone,gender,address,username, password, confirmpassword, dob, licenceno, storeno, nidno, type) 
          VALUES ('$Name', '$email' , '$mob', '$gender','$add','$userName', '$password', '$conPassword', '$dob', '$license', 
