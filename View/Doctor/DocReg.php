...
<body>
    ...
    <div class="topnav">
        ...
        <div class="form">
            <form method="POST" name="jsForm" onSubmit="submitForm(event)" action= "../../Controller/Doctor/docRegCheck.php">
            ...
            function submitForm(e)
        {
            ...
            gender == "" || dob == "") 
          {
            ...
            http.open("POST", `../../Controller/Doctor/DoctorRegCheck_JS.php`, true);
