...
<head>
    ...
    <script type="text/javascript" src="pReg.js"></script>
...
<body>
    ...
    <div class="topnav">
        ...
        <a href="../patient_view/login.php">Login</a>
        ...
        <div class="reg-container">
            ...
            <div class="reg-content">
                ...
                <a href="../patient_view/PatientReg.php">Patient</a>
    ...
    <div class="form">
        <form method="POST" name="jsForm" onSubmit="submitForm(event)" action= "../../Controller/pharmacy/pharmacyRegCheck.php">
                ...
                <center>
                <input type="submit" id="submit" name="submit" value="Submit"  style="width: 196px; display: inline-block; height: 45px">
                <input type="reset" id="submit" name="reset" value="Reset"  style="width: 196px; display: inline-block; height: 45px;">
                </center>
